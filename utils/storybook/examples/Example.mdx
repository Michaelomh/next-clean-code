...
<div className="sb-container">
  ...
  <div className="sb-section">
    <div className="sb-section-item">
      ...
      >Learn more<ChevronRight size={16}/></a>
    </div>
    <div className="sb-section-item">
...
<div className='sb-addon'>
  <div className='sb-addon-text'>
    ...
    <a
        ...
        target="_blank"
        className="sb-section-item-link"
      >Discover all addons<ChevronRight size={16}/></a>
  </div>
...
<div className="sb-section sb-socials">
    <div className="sb-section-item">
      ...
      <a
        ...
        target="_blank"
        className="sb-section-item-link"
      >Star on GitHub<ChevronRight size={16}/></a>
    </div>
    <div className="sb-section-item">
      <div>
        ...
        <a
          ...
          target="_blank"
          className="sb-section-item-link"
        >Join Discord server<ChevronRight size={16}/></a>
      </div>
    </div>
    <div className="sb-section-item">
      <div>
        ...
        <a
          ...
          target="_blank"
          className="sb-section-item-link"
        >Watch on YouTube<ChevronRight size={16}/></a>
      </div>
    </div>
    <div className="sb-section-item">
      ...
      <a
          ...
          target="_blank"
          className="sb-section-item-link"
        >Discover tutorials<ChevronRight size={16}/></a>
    </div>
