...
import { TbTbChevronRight } from 'react-icons/tb'
  ...
  <div className="sb-section">
    <div className="sb-section-item">
      ...
      <a
        ...
        target="_blank"
        className="sb-section-item-link"
      >Learn more<TbChevronRight /></a>
    </div>
    <div className="sb-section-item">
...
<div className='sb-addon'>
  <div className='sb-addon-text'>
    ...
    <a
        ...
        target="_blank"
        className="sb-section-item-link"
      >Discover all addons<TbChevronRight /></a>
  </div>
...
<div className="sb-section sb-socials">
    <div className="sb-section-item">
      ...
      <a
        ...
        target="_blank"
        className="sb-section-item-link"
      >Star on GitHub<TbChevronRight /></a>
    </div>
    <div className="sb-section-item">
      <div>
        ...
        <a
          ...
          target="_blank"
          className="sb-section-item-link"
        >Join Discord server<TbChevronRight /></a>
      </div>
    </div>
    <div className="sb-section-item">
      <div>
        ...
        <a
          ...
          target="_blank"
          className="sb-section-item-link"
        >Watch on YouTube<TbChevronRight /></a>
      </div>
    </div>
    <div className="sb-section-item">
      ...
      <a
          ...
          target="_blank"
          className="sb-section-item-link"
        >Discover tutorials<TbChevronRight /></a>
    </div>
